...
const PageFooter = () => {
    return (
        <footer className="xxs:h-auto bg-slate-800 text-white flex flex-col items-center justify-between p-4 text-xs sm:text-sm md:text-base">
            {/* Address Section */}
            <div className="flex flex-col xxs:flex-row items-center w-auto my-2 justify-center mb-2 cursor-default text-center xxs:text-left">
                <FontAwesomeIcon icon={faMapPin} className="xxs:h-4 w-4 md:h-5 md:w-5 mr-1"/>
                <div>
                    <b className="ml-0 mr-1">Mittapheap</b> Village,
                    <b className="ml-1 mr-1">Poipet</b> Commune,
                    <b className="ml-1 mr-1 block xxs:inline">Poipet</b>City,
            ...
            <div className="flex items-center justify-center my-1 cursor-default">
                <FontAwesomeIcon icon={faPhone} className="h-4 w-4 xxs:h-4 xxs:w-4 md:h-5 md:w-5 mr-2"/>
            ...
            {/* Copyright Section */}
            <div className="flex items-center justify-center mt-3 p-2 xxs:w-full md:w-1/2 border-2">
